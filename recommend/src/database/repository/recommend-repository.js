...
class RecommendRepository {
    ...
    async getMiddlePointOfItinerary(dailySchedules) {
        ...
        dailySchedules.forEach(schedule => {
            lat += schedule.morning.lat + schedule.afternoon.lat + (schedule.evening? schedule.evening.lat : 0);
            long += schedule.morning.long + schedule.afternoon.long + (schedule.evening? schedule.evening.long : 0);
        });
        return {
